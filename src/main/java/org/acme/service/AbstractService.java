...
public class AbstractService {
    ...
    public static final String ENTRY_CATEGORYID_COL = "categoryID";
    ...
    protected ScanRequest scanRequest() {
        return ScanRequest.builder().tableName(getTableName())
                .attributesToGet(ENTRY_CATEGORYID_COL, ENTRY_DESCRIPTION_COL, ENTRY_AMOUNT_COL, ENTRY_BALANCE_COL, ENTRY_DATE_COL).build();
    }

    protected PutItemRequest putRequest(Entry entry) {
        Map<String, AttributeValue> item = new HashMap<>();
        item.put(ENTRY_CATEGORYID_COL, AttributeValue.builder().s(entry.getCategoryID()).build());
    ...
    protected GetItemRequest getRequest(String name) {
        ...
        key.put(ENTRY_CATEGORYID_COL, AttributeValue.builder().s(name).build());

        return GetItemRequest.builder()
                .tableName(getTableName())
                .key(key)
                .attributesToGet(ENTRY_CATEGORYID_COL, ENTRY_DESCRIPTION_COL, ENTRY_AMOUNT_COL, ENTRY_BALANCE_COL, ENTRY_DATE_COL)
                .build();
    }
